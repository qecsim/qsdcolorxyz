    ...
    * This code is integrated into the command-line interface by the following entry in ``setup.cfg``:
    ...
    .. code-block:: text
        ...
        qecsim.cli.run.codes =
            ext_3qubit = qsdcolorxyz.threequbit:ThreeQubitCode
    ...
    * This code is integrated into the command-line interface by the following entry in ``setup.cfg``:
    ...
    .. code-block:: text
        ...
        qecsim.cli.run.error_models =
            ext_3qubit.bit_flip = qsdcolorxyz.threequbit:ThreeQubitBitFlipErrorModel
    ...
    * This code is integrated into the command-line interface by the following entry in ``setup.cfg``:
    ...
    .. code-block:: text
        ...
        qecsim.cli.run.decoders =
            ext_3qubit.lookup = qsdcolorxyz.threequbit:ThreeQubitLookupDecoder
