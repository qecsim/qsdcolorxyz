"""
This module contains tests of the qecsim extension examples defined in :mod:`qsdcolorxyz.threequbit`.
"""
import math
...
from qsdcolorxyz.threequbit import ThreeQubitCode, ThreeQubitBitFlipErrorModel, ThreeQubitLookupDecoder
